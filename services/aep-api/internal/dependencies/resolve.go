...
type DesignBundleReader interface {
...
// Absent options degrade gracefully: without a RepoLocator/DesignBundleReader the
...
func WithDesignReader(d DesignBundleReader) CatalogOption {
