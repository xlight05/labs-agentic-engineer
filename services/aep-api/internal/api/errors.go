...
func writeErrorEnvelope(w http.ResponseWriter, status int, code, msg string, details []models.ErrorDetail) {
	body := models.Error{Code: code, Message: msg, Details: details}
