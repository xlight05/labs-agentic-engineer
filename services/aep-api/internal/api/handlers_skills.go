...
func (s *apiServer) ListSkills(ctx context.Context, _ gen.ListSkillsRequestObject) (gen.ListSkillsResponseObject, error) {
	...
	out := models.SkillSummaryList{
		Skills:  make([]models.SkillSummary, 0, len(summaries)),
		RepoURL: s.deps.SkillSvc.RepoWebURL(ctx, org),
	}
	for _, sum := range summaries {
		out.Skills = append(out.Skills, models.SkillSummary{
			Name:        sum.Name,
			Kind:        sum.Kind,
...
func (s *apiServer) ImportSkill(ctx context.Context, request gen.ImportSkillRequestObject) (gen.ImportSkillResponseObject, error) {
	...
	return gen.ImportSkill201JSONResponse(models.ImportResult{
		Name:          result.Name,
		Kind:          result.Kind,
...
func (s *apiServer) ListSkillUpdates(ctx context.Context, _ gen.ListSkillUpdatesRequestObject) (gen.ListSkillUpdatesResponseObject, error) {
	...
	out := models.SkillUpdateList{
		Updates: make([]models.SkillUpdate, 0, len(updates)),
		Count:   int64(len(updates)),
	}
	for _, u := range updates {
		out.Updates = append(out.Updates, models.SkillUpdate{Name: u.Name})
	}
...
func (s *apiServer) SyncSkills(ctx context.Context, _ gen.SyncSkillsRequestObject) (gen.SyncSkillsResponseObject, error) {
	...
	return gen.SyncSkills200JSONResponse(models.SkillSyncOutput{
		Status:  "synced",
...
func skillDetailBody(sk *skills.Skill, editable bool) models.SkillDetailBody {
	return models.SkillDetailBody{
		OrgID:         sk.OrgID,
		Name:          sk.Name,
		Kind:          sk.Kind,
