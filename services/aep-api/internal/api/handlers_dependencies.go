...
func toPlatformResourceTypeDTOs(in []resources.PlatformResourceType) []models.PlatformResourceTypeDTO {
	out := make([]models.PlatformResourceTypeDTO, 0, len(in))
	for _, t := range in {
		out = append(out, models.PlatformResourceTypeDTO{
			Name:        t.Name,
