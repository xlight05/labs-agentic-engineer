...
// TemporalRunner is the production WorkflowRunner over the Temporal runtime:
// the readiness probe the build click runs before it claims a version, and the
// live status query behind a build read.
